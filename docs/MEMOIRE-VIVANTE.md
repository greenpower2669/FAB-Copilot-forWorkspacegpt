...
> **Contrat + carte exhaustive + histoire des erreurs + état du travail.**
>
...
| ✅ | [todo.md](../todo.md) | Qu'est-ce qui est fait, restant, bloqué ou à vérifier ? |
...
**Avant :** lire les quatre fichiers du dépôt travaillé, connaître le HEAD et la version stable, retrouver les exigences touchées.

**Pendant chaque modification :** actualiser immédiatement les sections pertinentes de `brain.md`, `brainmap.md`, `debughistorical.md`, `todo.md`. Examiner chacun des quatre ; ne pas modifier artificiellement un document réellement non affecté. Une architecture changée sans carte actualisée est un travail incomplet.
